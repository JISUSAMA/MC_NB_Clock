...
#region Core
    ...
    private Texture[] inputViews = new Texture[2];
        ...
        {
            LogUtil.Debug("RenderTrackingDevice - OnSceneLoaded");
        ...
        public void Initialize()
        {
            ...
            SRFaceTrackingState.Instance = GetComponent<SRFaceTrackingState>();
            if(SRFaceTrackingState.Instance == null)
            {
                SRFaceTrackingState.Instance = gameObject.AddComponent<SRFaceTrackingState>();
            }
        SRFaceTrackingState.Instance.enabled = true;
