...
namespace LeiaUnity
{
    public class EyeTracking : Singleton<EyeTracking>
    {
        ...
        private float nonPredictedFaceX, nonPredictedFaceY, nonPredictedFaceZ = 600;
        private float predictedFaceX, predictedFaceY, predictedFaceZ = 600;
        ...
        private float eyeTrackingProcessingTime;
        double t;
        private bool isProfilingEnabled;
        protected float delay;
        protected bool IsTracking;
        protected bool isPrimaryFaceSet;
